...
from src.modules.lessons.schemas import SLessonGetOut, SLessonUpdateInForClassroom, SLessonUpdateOutForClassroom
...
class SModuleUpdateOut(BaseModel):
    ...
    title: str
    description: str
    lessons: list[SLessonUpdateOutForClassroom]
